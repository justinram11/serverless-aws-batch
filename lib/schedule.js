...
module.exports.schedule = (event, context, callback) => {
    ...
    let params = {
        ...
        containerOverrides: {
            environment: [
                { name: "_X_AMZN_TRACE_ID", value: process.env._X_AMZN_TRACE_ID },
                ...
                { name: "AWS_LAMBDA_FUNCTION_MEMORY_SIZE", value: process.env.AWS_LAMBDA_FUNCTION_MEMORY_SIZE },
                { name: "AWS_LAMBDA_FUNCTION_TIMEOUT", value: process.env.AWS_LAMBDA_FUNCTION_TIMEOUT },
                { name: "AWS_LAMBDA_LOG_GROUP_NAME", value: process.env.AWS_LAMBDA_LOG_GROUP_NAME },
                { name: "AWS_LAMBDA_LOG_STREAM_NAME", value: process.env.AWS_LAMBDA_LOG_STREAM_NAME },
            ]
        }
    };
