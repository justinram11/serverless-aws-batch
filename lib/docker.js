...
function buildDockerImage() {
    ...
    ENTRYPOINT ["/bin/bash", "-c", "source", "/var/task/${this.serverless.service.service}/aws_environment.sh", "&&", "/var/lang/bin/python3.6", "/var/runtime/awslambda/bootstrap.py"]
    `
    )};
