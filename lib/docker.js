...
function buildDockerImage() {
    ...
    COPY aws_environment.sh /scripts/aws_environment.sh
    RUN chmod +x /scripts/aws_environment.sh
    ...
    ENTRYPOINT ["source", "/scripts/aws_environment.sh", "&", "/var/lang/bin/python3.6", "/var/runtime/awslambda/bootstrap.py"]
    `
    )};
