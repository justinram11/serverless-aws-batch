...
function buildDockerImage() {
    ...
    RUN rm -rf /tmp/*
    RUN /bin/sh -c yum install -y curl
    RUN /bin/sh -c curl -sL https://rpm.nodesource.com/setup_16.x | bash -
    ENV NODE_PATH=/opt/nodejs/node16/node_modules:/opt/nodejs/node_modules:/var/runtime/node_modules
    RUN /bin/sh -c node -v
