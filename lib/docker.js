...
function buildDockerImage() {
    ...
    FROM 368461407828.dkr.ecr.us-east-1.amazonaws.com/build-batch-image-base:latest AS builder
    USER root
    ...
    FROM 368461407828.dkr.ecr.us-east-1.amazonaws.com/batch-image-base:latest
    USER root
