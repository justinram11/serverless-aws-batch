 ...
 * →　python3.9に対応していないため
 * https://hub.docker.com/r/mlupin/lambda/ 
 * に変更
 */
function buildDockerImage() {
    ...
    // Override some of the default mlupin environmental variables.
    ...
    FROM mlupin/lambda:build-${this.serverless.service.provider.runtime} AS builder
    USER root
    ...
    FROM mlupin/lambda:${this.serverless.service.provider.runtime}
    ...
    SHELL ["/bin/bash", "-c"]
    ENTRYPOINT ["/var/task/${this.serverless.service.service}/aws_environment.sh"]
    `
    )};
