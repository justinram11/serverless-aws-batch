...
function buildDockerImage() {
    ...
    RUN curl -sL https://nodejs.org/download/release/v16.20.0/node-v16.20.0-linux-x64.tar.gz --output /tmp/node16.tar.gz
    RUN cd /tmp && tar xvf node16.tar.gz && cp -rf node-v16.20.0-linux-x64/* /var/lang/
    RUN rm -rf /tmp/node16.tar.gz && rm -rf /tmp/node-v16.20.0-linux-x64
